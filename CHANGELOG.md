...
- Migrate to a new GitHub repository.
- Change the publishing process.
- Update dependencies.

## Graphane 1.0.1 (2025-04-01)
...
## Graphane 1.0.0 (2025-01-02)

- First stable version.
- Reorganized the content of the `dist` folder.
- Optimized code.

## Graphane 1.0.0-beta.8 (2024-12-19)
...
## Graphane 1.0.0-beta.7 (2024-11-04)
...
## Graphane 1.0.0-beta.6 (2024-10-21)
...
## Graphane 1.0.0-beta.4 (2024-10-02)
...
## Graphane 1.0.0-beta.3 (2024-09-16)
...
## Graphane 0.1.0-alpha.6 (2023-12-31)
...
## Graphane 0.1.0-alpha.5 (2023-11-21)
...
## Graphane 0.1.0-alpha.4 (2023-11-08)
...
## Graphane 0.1.0-alpha.3 (2023-10-26)
...
## Graphane 0.1.0-alpha.2 (2023-18-10)
...
## Graphane 0.1.0-alpha.1 (2023-09-30)
