...
export function script () {
  ...
  document.querySelector('#run').addEventListener('click', () => {
    view.style.width  = (Number.parseInt(view.style.width) + 20) + 'px';
    view.style.height = (Number.parseInt(view.style.height) + 20) + 'px';
  });
...
export default `
<grapper-view data="n: 0" style="width: 100px; height: 100px">
