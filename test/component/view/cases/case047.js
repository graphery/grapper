...
export default `
<grapper-view style="width:350px">
   ...
   <script type="data">[
     {id: 'dog', image: '/test/component/view/assets/dog.svg', value: 55, color: 'chocolate'},
     {id: 'cat', image: '/test/component/view/assets/cat.svg', value: 35, color: 'darkslategray'}
   ]</script>
   <script type="methods">
   function load(el, r) {
