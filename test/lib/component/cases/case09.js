export const title       = '9) Rewrite config with attribute config-src="">'
...
export default `<my-component config-src="/test/lib/component/assets/config.json"></my-component>`;
