export const title       = '12) Size'
export const description = `Display a icon with custom size`;
...
export default `
  <my-icon value="2" style="width: 24px; height: 24px; border: 1px solid gray"></my-icon>
  <p>
    <select oninput="document.querySelector('my-icon').setAttribute('value', this.value)">
