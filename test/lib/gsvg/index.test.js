...
const results = {
  ...
  case42       : `<svg viewBox="0,0,100,100" width="100" height="100"> <path stroke="black" stroke-width="10" fill="none" d="M10,10L10,90L90,90L90,10Z"></path> </svg>`,
  case43       : `<svg viewBox="0,0,100,100" width="100" height="100"> <path stroke="black" stroke-width="10" fill="none" d="M10,10L10,90L90,90L90,10Z"></path> </svg>`,
  case44       : `<svg viewBox="0,0,100,100" width="100" height="100"> <rect x="10" y="10" width="90" height="90" transform="translate(30,30) scale(0.3, 0.3)"></rect> </svg>`,
  case45       : `<svg viewBox="0,0,100,100" width="100" height="100"> <rect x="10" y="10" width="90" height="90" transform="translate(30,30)scale(0.3,0.3)"></rect> </svg>`,
  ...
  case50       : `<svg viewBox="0,0,100,100" width="100" height="100"> <g> <g> <g> <g></g> <circle cx="50" cy="50" r="40"></circle> </g> <circle cx="50" cy="50" r="40"></circle> </g> <circle cx="50" cy="50" r="40"></circle> </g> <circle cx="50" cy="50" r="40"></circle> </svg>`,
  case51       : `<svg viewBox="0,0,100,100" width="100" height="100" fill="red" stroke="black"> <g> <g> <g> <g> <circle cx="50" cy="50" r="40"></circle> </g> </g> </g> </g> </svg>`,
}
